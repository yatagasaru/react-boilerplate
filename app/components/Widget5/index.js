...
function Widget5() {
  const greenData = [{x: '08 Mar', y: 25000}, {x: '09', y: 20000}, {x: '10', y: 18000}, {x: '11', y: 15000}, {x: '12', y: 10000}, {x: '13', y: 5000}, {x: '14', y: 0}];
    ...
    <WidgetContainer width="100%">
      ...
      <WidgetBody>
        ...
        <ListHeader borderless>
          <P fontSize="13px" color="#8F8F8F" className="cp">Last 7 days <i className="fas fa-fw fa-xs fa-chevron-down"></i></P>
          <P className="align-self-end cp" fontSize="12px" color="#74C97E">COURSE REPORT <i className="fas fa-fw fa-chevron-right"></i></P>
        </ListHeader>
      </WidgetBody>
    </WidgetContainer>
  )
